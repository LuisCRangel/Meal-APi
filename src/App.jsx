...
function App() {
  ...
  const productos = [
    ...
    { id: 4, name:'Pizza Salami y especias', price: 10.4, avatar:'https://cdn.computerhoy.com/sites/navi.axelspringer.es/public/media/image/2022/03/avatar-facebook-2632445.jpg?tf=3840x', src: 'https://www.saborusa.com/ni/wp-content/uploads/sites/19/2019/10/Disfruta-una-suculenta-pizza-al-estilo-New-York-en-Bogota-Foto-destacada.png' },
    ...
    { id: 7, name:'Ensaladas De Vegetales', price: 15.9, avatar:'https://cdn.computerhoy.com/sites/navi.axelspringer.es/public/media/image/2022/03/avatar-facebook-2632445.jpg?tf=3840x', src: 'https://media.istockphoto.com/id/188099381/es/foto/ensalada-de-vegetales-frescos-del-jard%C3%ADn-con.jpg?s=612x612&w=is&k=20&c=VzkIQaEwYbvZ25nIF8_AIdVGr3NS9gNuyYEWeOU5m88=' },
